...
// if everything is ok, try to upload file
	...
	$sql = $db->query("UPDATE studentuser SET picture = '$file_name' WHERE sn = '$sn' ") or die($db->error);
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">last stock</th>
                        ...
                        <tbody>
                        <?php $i=1; $sql = $db ->query("SELECT * FROM stock") ;
										  while($rows = $sql->fetch_assoc()) {
                            ?>
                          <tr class="even pointer">
                            <th scope="row"><?= $i++ ?></th>
                            <td><?= $rows['trid'] ?></td>
                            <td><?= sqLx('items','sn',$rows['itemid'],'title') ?></td>
                            <td><?= $rows['qty'] ?></td>
                        ...
                        <td>
											  <form method="POST">
											  <a class="btn btn-success"  href="addstock.php?sn=<?= $rows['sn'] ?>">Update</a>
										      </form></td>
                          </tr>
                          <?php } ?>
                        </tbody>
