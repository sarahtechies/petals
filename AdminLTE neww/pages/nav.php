  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">schoolportal</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">schoolportal</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="registerparents.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Register Guardians</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="registerstudents.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="class_category.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Category/Arm</p>
                </a>
              </li>
...
<li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="sturesult.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="resultsettings.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Result Settings</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="permission2.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="regslot.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
            <a href="managepromo.php" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Manage Promotions
                <i class="right fas fa-angle-left"></i>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="createfee.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
  ...
  <form method="POST" action="logout.php">
    <button type="submit" name="Logout">
          <i class="nav-icon fas fa-chart-pie"><p>Log Out</p></i>
</button>
</form>
</a>
</li>
