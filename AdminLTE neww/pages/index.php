        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-secondary">
              <div class="inner">
                <h3 class="students"><?= $pro->Total('students')?></h3>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number subjects"><?= $pro->Total('subjects') ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number staffs"><?= $pro->Total('staffs') ?></span>
              </div>
            </div>
          </div>
        </div>
                ...
                <ul class="users-list clearfix student_body">
                  ...
                  while ($rows = mysqli_fetch_assoc($sql)) { ?>
                    <li>
                      ...
                      <span class="users-list-date"><?= $pro->SqLx('class', 'sn', $rows['category'], 'category') ?></span>
                    </li>
                  <?php } ?>
