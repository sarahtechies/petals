                                       ...
                                       <td><?= $rows['name'] . ' (' . $pro->staffrole($rows['role']) . ') ' ?> </td>
                                        <td class="text-center">
                                            ...
                                            <div class="icheck-primary">
                                                <input type="checkbox" name="p1" <?php if($pro->sqLx1('permission', 'staff_id', $staff_id, 'p1') == 1) { ?> checked <?php }  ?> value="1"  id="reg <?= $staff_id ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="icheck-primary">
                                                <input type="checkbox" name="p2" <?php if($pro->sqLx1('permission', 'staff_id', $staff_id, 'p2') == 1) { ?> checked <?php }  ?> value="1" id="fee2 <?= $staff_id ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <input type="checkbox" name="p3" <?php if($pro->sqLx1('permission', 'staff_id', $staff_id, 'p3') == 1) { ?> checked <?php }  ?>value="1" id="u_result2 <?=$staff_id ?>">
                                        ...
                                        <td class="text-center">
                                            <div class="icheck-primary">
                                              <input type="checkbox" name="p4" <?php if($pro->sqLx1('permission', 'staff_id', $staff_id, 'p4') == 1) { ?> checked <?php }  ?>value="1" id="p4 <?= $staff_id ?>">
                                              <label for="p4 <?= $staff_id ?>" data-id="p4<?= $staff_id ?>"></label>
                                            </div>
                                        </td>

                                         <td ><button class="btn btn-xs btn-success save_change float-right" type= "submit"name="updatepermission"><i class="fas fa-save"></i> Save</button></td>
