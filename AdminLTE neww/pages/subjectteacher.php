                    ...
                    <div class="card-body p-1">
                        <div class="table-responsive">
                            <table id="example1" class="table mb-0 table-bordered table-hover table-striped">
                                ...
                                <tbody id="sub_body">
                                    <tr>
                                         <?php $i=1; $sql = $con->query("SELECT * FROM  subject_teachers");
                                        while($rows = mysqli_fetch_assoc($sql)){ ?>

                                             <tr>
                                         <td colspan="12"><?=$i++ ?></td>
                                          <td colspan="12"><?=$pro->SqLx('subjects', 'sn', $rows['subject'], 'subject') ?></td>
                                         <td colspan="12"><?=$pro->SqLx('class', 'sn', $rows['class'], 'category') ?></td>
                                         <td colspan="12"><?=$pro->SqLx('staffs', 'sn', $rows['teacher'], 'name') ?></td>
                ...
                <div class="modal-body">
                    <form method="POST" class="row" id="assignSubject">
                        ...
                        <div class="col-12 form-group">
                            <button type="submit" class="btn btn-secondary float-right assignSubject" name="assignsubjects">Assign Subject</button>
                        </div>
                    </form>
                </div>
